Shader "FirearmSDKv2/Thermal/Black Hot"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        CBUFFER_END
            ...
            Gradient _GradientBlackHot_Definition()
            {
                ...
                g.colors[1] = float4(0.3207547, 0.3192417, 0.3192417, 0.02352941);
                g.colors[2] = float4(0.02830189, 0.02830189, 0.02830189, 0.08529793);
                g.colors[3] = float4(0, 0, 0, 0.2911727);
                g.colors[4] = float4(0, 0, 0, 1);
                g.colors[5] = float4(0, 0, 0, 0);
                g.colors[6] = float4(0, 0, 0, 0);
                g.colors[7] = float4(0, 0, 0, 0);
                g.alphas[0] = float2(1, 0);
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                Gradient _Property_2292b031cc494bdf91466ae36752ce8c_Out_0 = _GradientBlackHot;
                ...
                Unity_SampleGradientV1_float(_Property_2292b031cc494bdf91466ae36752ce8c_Out_0, _Multiply_5caac94c233a4e2e9905b91aa4048fb5_Out_2, _SampleGradient_9630b58f660448da9b03f0aa70f4f130_Out_2);
